...
export const themeDireitosAutorData: ThemeDefinition = {
  ...
  lessons: [
    ...
    {
      eyebrow: { pt: 'Partilha Aberta', en: 'Open Sharing' },
      h: { pt: 'Creative Commons (CC): As 6 Licenças e os 4 Símbolos', en: 'Creative Commons (CC): 6 Licenses & 4 Symbols' },
      body: {
        pt: 'A <strong>Creative Commons</strong> é uma organização que ajuda pessoas de todo o mundo a partilhar criações de forma legal e segura. Só precisas de conhecer 4 símbolos divertidos:<ul><li><strong>BY (Atribuição 👤):</strong> Podes usar, mas tens de indicar sempre o nome do autor!</li><li><strong>NC (Não Comercial 🚫💲):</strong> Não podes usar para ganhar dinheiro nem vender!</li><li><strong>SA (Partilha pela mesma licença 🔁):</strong> Se alterares a obra, tens de partilhar com as mesmas regras!</li><li><strong>ND (Sem Derivações =):</strong> Podes partilhar a obra inteira, mas não a podes cortar nem modificar!</li></ul>A combinação destas 4 regras dá origem às <strong>6 licenças Creative Commons</strong> oficiais!',
        en: 'Creative Commons allows legal sharing using 4 simple rules: BY (credit author), NC (non-commercial), SA (share-alike), and ND (no derivatives), combining into 6 official licenses.',
      },
      icon: '⚖️',
    },
    {
