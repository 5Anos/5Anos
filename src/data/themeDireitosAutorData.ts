...
export const themeDireitosAutorData: ThemeDefinition = {
  ...
  modules: [
    ...
    },
    {
      ...
      explanation: {
        pt: [
          'Copyright: Protege a obra intelectual original e os direitos do autor. O direito nasce com a criação da obra e o símbolo © identifica a proteção e o titular dos direitos. A sua utilização requer, em regra, autorização prévia, salvo exceções legais.',
          'Copyleft: É um princípio de licenciamento baseado nos direitos de autor que permite utilizar, modificar e partilhar uma obra, exigindo que as obras derivadas sejam partilhadas sob a mesma licença.',
          'Royalty Free: Modalidade em que não é necessário pagar uma taxa ("royalty") por cada utilização da obra. No entanto, a obra continua protegida por direitos de autor e deve ser utilizada cumprindo sempre as condições e termos da respetiva licença.',
          'Creative Commons (CC): Conjunto de licenças que permitem aos autores partilhar as suas obras com regras claras (como indicar o autor BY, não comercial NC, partilha com a mesma licença SA ou sem alterações ND).',
          'Domínio Público: Quando os direitos patrimoniais de uma obra expiram (normalmente muitos anos após a morte do autor), a obra passa ao Domínio Público e pode, em geral, ser utilizada e partilhada sem pedir autorização por direitos de autor, mantendo-se o respeito pela autoria original.',
        ],
        en: [
          'Copyright: Protects original intellectual works and creator rights. Rights exist upon creation and use generally requires prior permission subject to statutory exceptions.',
          'Copyleft: A copyright-based licensing model that allows using, modifying, and sharing, requiring derivative creations to keep the same license.',
          'Royalty Free: Means no per-use fee is charged, but the work remains copyrighted and subject to its specific license terms and conditions.',
          'Creative Commons (CC): Standard licenses allowing creators to share works under clear rules (BY, NC, SA, ND).',
          'Public Domain: When economic copyrights expire, works enter the Public Domain and can be used without permission, while still respecting original authorship.',
        ],
      },
      example: {
        title: {
  ...
  finalQuiz: [
    ...
    },
    {
      ...
      options: {
        pt: [
          'Permite alterar a obra se os derivados mantiverem a mesma licença livre',
          'Obriga a que todas as alterações sejam registadas mediante pagamento',
          'Impede a visualização ou partilha do ficheiro fora da escola do autor',
          'Reserva todos os direitos exclusivos apenas para a editora original',
        ],
        en: [
          'Allows modifying the work if derived creations maintain the same free license',
          'Requires all modifications to be registered through a mandatory fee',
          'Prevents viewing or sharing the file outside the author’s school',
          'Reserves all exclusive rights only for the original publishing house',
        ],
      },
      correctIndex: 0,
      explanation: {
    ...
    },
    {
      ...
      options: {
        pt: [
          'Licenças que indicam aos utilizadores as condições de partilha da obra',
          'Normas técnicas que definem o formato dos ficheiros de imagem e texto',
          'Programas antivírus que bloqueiam transferências não autorizadas',
          'Contratos de exclusividade para a venda de computadores e periféricos',
        ],
        en: [
          'Licenses specifying the conditions under which works can be shared and reused',
          'Technical standards defining file formats for images and text documents',
          'Antivirus software blocking unauthorized downloads from the web',
          'Exclusive contracts for commercial sales of computers and peripherals',
        ],
      },
      correctIndex: 0,
      explanation: {
    ...
    },
    {
      ...
      options: {
        pt: [
          'Usar imagens com licenças abertas ou domínio público e indicar a fonte',
          'Copiar imagens protegidas sem verificar nem mencionar a autoria original',
          'Retirar marcas de identificação de ficheiros protegidos para os reutilizar',
          'Utilizar apenas capturas de ecrã parciais para evitar citar os autores',
        ],
        en: [
          'Use images with open licenses or public domain and cite the source',
          'Copy copyrighted images without checking or crediting original authorship',
          'Remove watermarks from protected files to reuse them in projects',
          'Use partial screenshots specifically to avoid citing original authors',
        ],
      },
      correctIndex: 0,
      explanation: {
    ...
    },
    {
      ...
      options: {
        pt: [
          ...
          'Indica que o conteúdo pertence ao domínio público universal',
          'Significa que o ficheiro pode ser comercializado sem restrições',
          'Indica que a obra só pode ser visualizada em suporte físico impresso',
        ],
        en: [
          'It means the work is protected by copyright',
          'It indicates the content belongs to universal public domain',
          'It means the file can be freely sold without restrictions',
          'It means the work can only be viewed in printed physical media',
        ],
      },
      correctIndex: 0,
      explanation: {
    ...
    },
    {
      ...
      options: {
        pt: [
          'Sim, porque foste tu quem os criou e és o autor da tua obra',
          'Não, porque os trabalhos de crianças não beneficiam de proteção autoral',
          'Apenas se forem formalmente registados num cartório oficial',
          'Não, porque todo o material escolar passa a pertencer apenas à escola',
        ],
        en: [
          'Yes, because you created them and you are the author of your work',
          'No, because student work does not benefit from author protection',
          'Only if formally registered with an official copyright office',
          'No, because all school assignments belong strictly to the school',
        ],
      },
      correctIndex: 0,
      explanation: {
    ...
    },
    {
      ...
      options: {
        pt: [
          'Em plataformas com licenças abertas ou domínio público (ex.: Pixabay)',
          'Em sites não oficiais que distribuem conteúdos comerciais protegidos',
          'Em contas privadas de redes sociais de utilizadores sem autorização prévia',
          'Em fóruns de videojogos comerciais que partilham capturas sem licença',
        ],
        en: [
          'On platforms with open licenses or public domain (e.g., Pixabay)',
          'On unauthorized websites distributing protected commercial content',
          'On private social media profiles of strangers without prior consent',
          'On commercial gaming forums sharing unauthorized screen recordings',
        ],
      },
      correctIndex: 0,
      explanation: {
