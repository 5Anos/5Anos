...
export const themePalavrasPasseData: ThemeDefinition = {
    ...
    },
    {
      ...
      explanation: {
        pt: [
          ...
          'Autenticação de Dois Fatores (2FA) ou Confirmação Suplementar: funciona como uma fechadura dupla! Além de introduzires a tua palavra-passe normal, precisas de um segundo passo de verificação (como um código temporário numa aplicação ou mensagem, ou a confirmação num dispositivo de confiança). Assim, mesmo que alguém descubra a tua palavra-passe, não consegue aceder à tua conta sem essa confirmação extra.',
        ],
        en: [
  ...
  finalQuiz: [
    ...
    },
    {
      id: 'pass-q5',
      question: {
        pt: 'A conta de email da escola do Tiago tem a Autenticação de Dois Fatores (2FA) ativada. Quando o Tiago tenta entrar na conta, o que lhe é solicitado além da palavra-passe?',
        en: 'Tiago’s school email account has Two-Factor Authentication (2FA) enabled. When Tiago logs in, what is required in addition to his password?',
      },
      options: {
        pt: [
          'Um segundo passo de verificação (como um código temporário numa aplicação ou confirmação num dispositivo de confiança)',
          'O pagamento obrigatório de uma taxa em dinheiro',
          'A resposta a um teste de Matemática de 10 perguntas',
          'A alteração obrigatória da palavra-passe em cada acesso',
        ],
        en: [
          'A second verification step (such as a temporary code in an app or confirmation on a trusted device)',
          'A mandatory payment of a cash fee',
      ...
      correctIndex: 0,
      explanation: {
        pt: 'A Autenticação de Dois Fatores (2FA) adiciona um segundo passo de verificação além da palavra-passe (como um código temporário, uma confirmação num dispositivo de confiança ou uma chave de segurança), tornando a conta muito mais protegida.',
        en: 'Two-Factor Authentication (2FA) adds a second verification step in addition to your password (such as a temporary code, trusted device confirmation, or security key), making the account much more secure.',
      },
      optionExplanations: {
        pt: [
          'Esta é a resposta correta! O segundo passo de verificação adiciona uma barreira extra de proteção à conta.',
          ...
          'Esta opção está errada. A 2FA solicita uma confirmação suplementar e não exige mudar a palavra-passe.',
        ],
        en: [
          'Correct answer! The second verification step adds an extra layer of protection to the account.',
          ...
          'Incorrect. 2FA asks for a temporary verification step, not a password change.',
        ],
      },
    },
    {
      ...
      options: {
        pt: [
          'Porque qualquer pessoa que passe perto do computador pode ver a palavra-passe',
          'Porque os computadores deixam de aceitar palavras-passe escritas em papel',
          'Porque a câmara do computador não consegue ler o texto anotado no papel',
          'Porque o monitor perde a definição e o brilho quando tem papéis colados',
        ],
        en: [
          'Because anyone walking past the computer can see the password',
          'Because computers stop accepting passwords written on paper',
          'Because the computer webcam cannot read text noted on paper',
          'Because the monitor loses resolution and brightness when notes are taped',
        ],
      },
      correctIndex: 0,
      explanation: {
      ...
      optionExplanations: {
        pt: [
          ...
          'Esta opção está errada. O computador continua a aceitar a chave, o perigo é ficar visível para outros.',
          'Esta opção está errada. A câmara não tem função de ler papéis no monitor.',
          'Esta opção está errada. O papelinho não afeta o ecrã, mas retira toda a privacidade à conta.',
        ],
        en: [
          'Correct answer! Leaving keys visible allows anyone to view and use them without permission.',
          'Incorrect. The computer will accept the key, but it becomes visible to others.',
          'Incorrect. Webcams do not read notes taped on monitors.',
          'Incorrect. Sticky notes do not affect display quality, but expose credentials.',
        ],
      },
    },
    {
      ...
      options: {
        pt: [
          'Uma tentativa de roubo de dados (phishing) e nunca deve fornecer a chave',
          'Um procedimento normal de manutenção da plataforma do jogo',
          'Um aviso automático para verificar se a conta ainda está ativa',
          'Uma mensagem de um colega a pedir para jogar em equipa',
        ],
        en: [
          'A phishing attempt to steal data and she must never share the key',
          'A normal maintenance procedure by the gaming platform',
          'An automated check to verify if the account is still active',
          'A message from a classmate asking to team up in the game',
        ],
      },
      correctIndex: 0,
      explanation: {
      ...
      optionExplanations: {
        pt: [
          ...
          'Esta opção está errada. As plataformas nunca pedem palavras-passe para verificar atividade.',
          'Esta opção está errada. Trata-se de uma mensagem fraudulenta de desconhecidos.',
        ],
        en: [
          ...
          'Incorrect. Platforms never ask for passwords to verify activity.',
          'Incorrect. It is a fraudulent message from unknown actors.',
        ],
      },
    },
    {
      ...
      options: {
        pt: [
          ...
          'Um motor de busca público na Internet',
          'Uma folha de cálculo partilhada com os amigos',
          'Um serviço de armazenamento de fotografias',
        ],
        en: [
          'A Password Manager',
          'A public Internet search engine',
          'A spreadsheet shared with friends',
          'A photo cloud storage service',
        ],
      },
      correctIndex: 0,
      explanation: {
      ...
      optionExplanations: {
        pt: [
          ...
          'Esta opção está errada. Motores de busca pesquisam a web e não guardam dados privados com segurança.',
          'Esta opção está errada. Folhas de cálculo partilhadas deixam as palavras-passe visíveis para outras pessoas.',
          'Esta opção está errada. Serviços de fotografia servem para imagens e não são cofres de credenciais.',
        ],
        en: [
          'Correct answer! A password manager generates and stores strong keys in an encrypted vault.',
          'Incorrect. Search engines index web pages, they do not secure private passwords.',
          'Incorrect. Shared spreadsheets make passwords visible to other people.',
          'Incorrect. Photo services store images, not encrypted credential vaults.',
        ],
      },
    },
    {
      ...
      options: {
        pt: [
          'Porque são padrões óbvios testados rapidamente por programas de ataque',
          'Porque ocupam demasiado espaço de armazenamento nos servidores',
          'Porque impedem o início de sessão em computadores portáteis',
          'Porque tornam o computador mais lento ao carregar páginas',
        ],
        en: [
          'Because they are obvious patterns quickly tested by cracking tools',
          'Because they take up excessive storage space on servers',
          'Because they prevent signing in on laptop computers',
          'Because they slow down web page loading on the computer',
        ],
      },
      correctIndex: 0,
      explanation: {
      ...
      optionExplanations: {
        pt: [
          ...
          'Esta opção está errada. O tamanho e tipo da palavra-passe não alteram o espaço de armazenamento.',
          'Esta opção está errada. A sequência funciona em qualquer aparelho, mas é muito fraca.',
          'Esta opção está errada. A palavra-passe não altera o desempenho da Internet.',
        ],
        en: [
          'Correct answer! Automated scripts crack obvious sequences instantly.',
          'Incorrect. Password choice has no effect on server storage.',
          'Incorrect. The password works across devices, but remains weak.',
          'Incorrect. Passwords do not affect network performance.',
        ],
      },
    },
    {
      ...
      options: {
        pt: [
          'Não partilhar o código com ninguém e verificar a segurança da conta',
          'Enviar o código para o contacto que o solicitar por mensagem',
          'Partilhar o código num grupo de mensagens com colegas da turma',
          'Desativar de imediato a ligação Wi-Fi e desligar o telemóvel',
        ],
        en: [
          'Do not share the code with anyone and check account security',
          'Send the code to whoever requests it by direct message',
          'Share the code in a chat group with school classmates',
          'Immediately turn off Wi-Fi connection and shut down the phone',
        ],
      },
      correctIndex: 0,
      explanation: {
