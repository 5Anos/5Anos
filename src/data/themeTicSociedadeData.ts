        ...
        },
        {
          ...
          options: {
            pt: [
              ...
              'Jogar no telemóvel na cama com as luzes apagadas até adormecer de cansaço',
              'Passar 7 horas seguidas a olhar para o computador sem beber água nem levantar',
              'Substituir o almoço e o convívio em família por vídeos na Internet',
            ],
            en: [
              'Take regular breaks, balance with sports, and turn off screens at least 1 hour before bedtime',
              'Play on your phone in the dark until falling asleep from exhaustion',
              'Spend 7 consecutive hours staring at a screen without stretching or drinking water',
              'Replace meals and family time with online videos',
            ],
          },
          correctIndex: 0,
          explanation: {
