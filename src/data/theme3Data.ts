        ...
        },
        {
          ...
          options: {
            pt: [
              ...
              'Clicar logo em todos os resultados patrocinados que aparecerem',
              'Copiar o primeiro texto que encontrares sem avaliar a autoria',
              'Desativar os filtros de segurança do navegador',
            ],
            en: [
              'Clearly define what you need to discover or answer',
              'Immediately click all sponsored results that appear',
              'Copy the first text you find without verifying authorship',
              'Deactivate browser security filters',
            ],
          },
          correctIndex: 0,
          explanation: {
      ...
      quizQuestions: [
        {
          ...
          options: {
            pt: ['Vírus e cavalos de Troia', 'Aranhas ou robôs rastreadores (crawlers)', 'Servidores de correio eletrónico (SMTP)', 'Sistemas de firewall escolares'],
            en: ['Viruses and trojan horses', 'Spiders or web crawlers', 'Mail transfer servers (SMTP)', 'School firewall systems'],
          },
          correctIndex: 1,
          explanation: {
    ...
    // CONTEÚDO 3
    {
      ...
      quizQuestions: [
        ...
        },
        {
          ...
          options: {
            pt: [
              'O motor de busca rejeita os termos e devolve uma mensagem de erro',
              'O motor de busca trata as maiúsculas e minúsculas da mesma forma',
              'O motor de busca pesquisa apenas em títulos de páginas Web',
              'O motor de busca dá prioridade exclusiva a ficheiros PDF',
            ],
            en: [
              'The search engine rejects the terms and throws an error',
              'The search engine treats uppercase and lowercase words the same way',
              'The search engine searches only inside webpage title tags',
              'The search engine prioritizes PDF documents exclusively',
            ],
          },
          correctIndex: 1,
          explanation: {
        ...
        },
        {
          ...
          options: {
            pt: [
              'A pesquisa falha por falta de memória do navegador',
              'Vais obter milhões de resultados genéricos que não respondem à tua dúvida concreta',
              'O motor de busca desativa a ligação cifrada HTTPS',
              'Não existe qualquer desvantagem em usar termos genéricos',
            ],
            en: [
              'The query fails due to lack of browser memory',
              'You will receive millions of generic results that do not answer your specific question',
              'The search engine drops the secure HTTPS connection',
              'There is zero disadvantage in using generic search terms',
            ],
          },
          correctIndex: 1,
          explanation: {
      ...
      quizQuestions: [
        {
          ...
          options: {
            pt: [
              'Para pesquisar apenas em ficheiros de imagem vetorial',
              'Para procurar as palavras exatamente juntas e na mesma ordem',
              'Para eliminar os resultados protegidos por direitos de autor',
              'Para ordenar os resultados alfabeticamente pelo título',
            ],
            en: [
              'To search only within vector graphic images',
              'To search for words together in that exact sequence',
              'To eliminate copyright-protected search results',
              'To sort results alphabetically by title',
            ],
          },
          correctIndex: 1,
          explanation: {
        ...
        },
        {
          ...
          options: {
            pt: [
              ...
              'Guardar nos marcadores como facto científico comprovado',
              'Copiar o texto integralmente para o trabalho sem indicar a fonte',
            ],
            en: [
              ...
              'Save to browser bookmarks as a proven scientific fact',
              'Copy the full text into your project without citing the source',
            ],
          },
          correctIndex: 1,
          explanation: {
    ...
    // CONTEÚDO 6
    {
      ...
      quizQuestions: [
        ...
        },
        {
          ...
          options: {
            pt: [
              ...
              'Traduzir o texto automaticamente sem rever o sentido',
              'Substituir apenas os pontos finais por vírgulas',
            ],
            en: [
              ...
              'Automatically translating the text without reviewing the meaning',
              'Replacing only periods with commas in the text',
            ],
          },
          correctIndex: 1,
          explanation: {
        ...
        },
        {
          ...
          options: {
            pt: [
              'Na pasta de transferências do computador',
              'Numa secção final de Bibliografia ou Webgrafia / Fontes consultadas',
              'Apenas nas palavras-passe guardadas no navegador',
              'No histórico de navegação temporário da sessão',
            ],
            en: [
              'In the local downloads folder of the computer',
              'In a final Bibliography or Web sources / References section',
              'Only inside saved browser passwords',
              'In the temporary browser session history',
            ],
          },
          correctIndex: 1,
          explanation: {
      ...
      quizQuestions: [
        {
          ...
          options: {
            pt: [
              'Histórico de ficheiros transferidos',
              'Marcadores (ou Favoritos)',
              'Janela de navegação privada',
              'Gestor de palavras-passe do sistema',
            ],
            en: [
        ...
        },
        {
          ...
          options: {
            pt: [
              'Copiar todo o conteúdo encontrado para o documento sem seleção',
              'Selecionar as ideias essenciais, organizar por tópicos e explicar com as tuas palavras',
              'Converter todas as páginas em ficheiros executáveis (.exe)',
              'Apagar todas as referências às fontes consultadas',
            ],
            en: [
              'Copy all found content into the document without curation',
              'Filter key points, structure by topics, and explain in your own words',
              'Convert all web pages into executable files (.exe)',
              'Delete all references to the consulted sources',
            ],
          },
          correctIndex: 1,
          explanation: {
  ...
  finalQuiz: [
    {
      ...
      options: {
        pt: [
          'A pesquisa só funciona em computadores portáteis com ligação por cabo',
          'A pesquisa tem um objetivo concreto, uma pergunta clara e procura respostas fiáveis',
          'A navegação só pode ser feita em motores de busca comerciais',
          'Não há qualquer diferença funcional entre as duas atividades',
        ],
        en: [
          'Searching only works on laptops with wired connections',
          'Searching has a concrete goal, a clear question, and seeks reliable answers',
          'Browsing can only occur on commercial search engines',
          'There is zero functional difference between the two activities',
        ],
      },
      correctIndex: 1,
      explanation: {
    ...
    },
    {
      ...
      options: {
        pt: [
          ...
          'Consultam apenas os ficheiros guardados na pasta de transferências do computador',
          'Enviam uma mensagem de correio a cada proprietário de site em tempo real',
          'Fazem uma cópia integral da Internet na memória RAM de cada dispositivo',
        ],
        en: [
          'They crawl pages using spiders (crawlers), index them into a massive catalog, and rank by relevance',
          'They check only files stored in the local computer downloads folder',
          'They send an email message to every website owner in real time',
          'They create a full copy of the entire Internet in device RAM memory',
        ],
      },
      correctIndex: 0,
      explanation: {
    ...
    },
    {
      ...
      options: {
        pt: [
          ...
          'Para pesquisar apenas ficheiros guardados no disco rígido local',
          'Para excluir termos patrocinados dos primeiros resultados',
          'Para traduzir automaticamente os termos para outro idioma',
        ],
        en: [
          'To force the engine to match that exact continuous phrase in that specific order',
          'To search only files saved on the local hard drive',
          'To exclude sponsored terms from top results',
          'To automatically translate the terms to another language',
        ],
      },
      correctIndex: 0,
      explanation: {
    ...
    },
    {
      ...
      options: {
        pt: [
          'Para mostrar apenas páginas que contenham ambas as palavras obrigatoriamente',
          'Para procurar "camaleão" excluindo páginas que contenham a palavra "réptil"',
          'Para pesquisar apenas imagens com a palavra "réptil"',
          'Para ordenar os resultados por ordem alfabética inversa',
        ],
        en: [
          'To display only pages containing both words necessarily',
          'To search for "camaleao" while excluding pages containing the word "reptil"',
          'To search only for images containing the word "reptil"',
          'To sort results in reverse alphabetical order',
        ],
      },
      correctIndex: 1,
      explanation: {
    ...
    },
    {
      ...
      options: {
        pt: [
          'Descarregar o instalador do navegador para o ambiente de trabalho',
          'Adicionar aos Marcadores / Favoritos do navegador (atalho Ctrl + D)',
          'Alterar o endereço de IP da placa de rede',
          'Desativar a proteção contra páginas fraudulentas',
        ],
        en: [
          'Download the browser installer onto the desktop',
          'Add to browser Bookmarks / Favorites (shortcut Ctrl + D)',
          'Change the network card IP address',
          'Disable deceptive website protection',
        ],
      },
      correctIndex: 1,
      explanation: {
