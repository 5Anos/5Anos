    ...
    <div className="max-w-4xl mx-auto px-4 py-8 space-y-6 animate-in fade-in duration-200">
      ...
      {!gameOver ? (
        ...
        <div className="bg-white rounded-[2rem] border border-slate-200 p-8 text-center space-y-6 shadow-xs">
          ...
          <div className="inline-flex items-center gap-3 p-3 rounded-2xl bg-violet-50 border border-violet-200 text-violet-950 font-extrabold text-sm sm:text-base">
            <Sparkles className="w-5 h-5 text-violet-600" />
            <span>{Math.round((score / 90) * 100)}% de Precisão</span>
            <span>•</span>
            <span className="text-violet-700">{Math.round((score / 90) * 100)} XP</span>
          </div>
