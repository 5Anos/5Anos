...
import { UserX, ShieldAlert, CheckCircle2, UserCheck, MessageCircle, AlertTriangle } from 'lucide-react';
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-base sm:text-lg font-black text-slate-900">
              {language === 'pt' ? 'Laboratório de Redes Sociais: Pedido de Amizade Suspeito' : 'Social Lab: Suspicious Friend Request'}
            </h3>
