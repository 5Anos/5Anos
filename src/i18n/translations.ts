export const translations = {
  pt: {
    ...
    navTheme2: 'Ergonomia',
    navTheme3: 'Palavras-passe',
    navTheme4: 'Segurança Digital',
    navTheme5: 'Navegar na Internet',
    navTheme6: 'Correio Eletrónico',
    navTheme7: 'Direitos de Autor',
    ...
    exploreThemes: 'Os Sete Grandes Temas de TIC',
  ...
  en: {
    ...
    navTheme3: 'Passwords',
    navTheme4: 'Digital Security',
    navTheme5: 'Internet Browsing',
    navTheme6: 'Electronic Mail',
    navTheme7: 'Copyright',
    ...
    exploreThemes: 'The Seven Core ICT Themes',
