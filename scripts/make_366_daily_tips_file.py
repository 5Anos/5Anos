...
# Generator script that creates src/data/dailyTipsData.ts with 366 unique entries

months_data = [
    # M1: Janeiro - Hardware e Software (31)
    (1, "Janeiro", "January", 31, "hardware-software", 1, "Hardware e Software", "Hardware and Software", "bg-blue-100 text-blue-800 dark:bg-blue-900/40 dark:text-blue-300", "Fundamentos de TIC", "ICT Fundamentals", "Monitor", [
